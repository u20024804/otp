...
-define(SP_STKFRAME_OFFSET,    0).                                          % 0 bytes
-define(SP_STKARITY_OFFSET,    (?SP_STKFRAME_OFFSET + ?SP_STKFRAME_SIZE) ). % 4 bytes
-define(SP_LIVEROOTCNT_OFFSET, (?SP_STKARITY_OFFSET + ?SP_STKARITY_SIZE) ). % 8 bytes
